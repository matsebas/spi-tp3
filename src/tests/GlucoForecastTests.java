...
public class GlucoForecastTests {
    ...
    public void testRegistrarGlucemiaValida() {
        try {
            ...
            assert paciente.getHistorialMediciones().size() == 1 : "Error: registro de glucemia válida falló.";
    ...
    public void testRegistrarCarbohidratos() {
        try {
            ...
            assert paciente.getHistorialMediciones().size() == 1 : "Error: registro de carbohidratos falló.";
    ...
    public void testRegistrarInsulina() {
        try {
            ...
            assert paciente.getHistorialMediciones().size() == 1 : "Error: registro de insulina falló.";
    ...
    public void testCalculoHbA1cInsuficiente() {
        try {
            paciente.getHistorialMediciones().clear();
            medicionesController.registrarGlucemia(paciente, 120, "Desayuno", "DESAYUNO");
